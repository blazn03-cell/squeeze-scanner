# ==========================================================================
# V4_HIGH_RVOL_SCAN.ts
# ==========================================================================
# PURPOSE      : Unusual participation that is NOT just a one-bar spike.
# AGGREGATION  : Daily, or 15m intraday.
...
# OUTPUT       : true = symbol passes. Relative volume above threshold with the spike filter applied.
...
input minRvol      = 2.0;
input minVolTrend  = 1.2;
input minStable    = 45;

plot scan = rvolSafe >= minRvol
        and volTrend >= minVolTrend
        and !spike
