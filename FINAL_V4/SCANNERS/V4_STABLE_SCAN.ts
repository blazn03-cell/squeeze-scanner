...
# V4_STABLE_SCAN.ts
# ==========================================================================
# PURPOSE      : The plain quality filter — high StableScore, direction agnostic.
...
# OUTPUT       : true = symbol passes. StableScore at or above minStable with the liquidity floor enforced.
# COLORS       : n/a — scan filters have no colour output.
# LIMITATIONS  : Exactly one plot, no labels, no bubbles, no secondary aggregation. Set the scan aggregation in the Study Filter's own dropdown and keep it identical to your watchlist columns or the numbers will not match. Defaults follow the project's existing 60 threshold. 65 = stronger, 75 = elite.
# ==========================================================================
...
plot scan = stableScore >= minStable and dollarVol >= minDollarVol;
