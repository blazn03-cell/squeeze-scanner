...
# V4_BREAKOUT_SCAN.ts
# ==========================================================================
# PURPOSE      : Approaching or confirming a Darvas breakout with real participation.
# AGGREGATION  : Daily for swing, 15m/30m intraday.
...
# OUTPUT       : true = symbol passes. States 1-3 on DarvasScan, filtered for volume and non-extension.
