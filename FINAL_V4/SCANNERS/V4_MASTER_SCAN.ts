...
def pathScore     = v4Score >= minScore and v4Confirmed >= 3 and AbsValue(direction) >= 1;
...
plot scan = liquid and (pathScore or pathBreakout or pathSqueeze or pathEarly);
