...
# LIMITATIONS  : Exactly one plot, no labels, no bubbles, no secondary aggregation. Set the scan aggregation in the Study Filter's own dropdown and keep it identical to your watchlist columns or the numbers will not match. Reversal scans are the highest false-positive family in any system. The flow-agreement and liquidity terms are what keep this usable — do not remove them to get more hits.
# ==========================================================================
...
plot scan = regime == 4
        ...
        and ((rsi < 32 and smartFlow > 10) or (rsi > 68 and smartFlow < -10))
        and !spike
