...
# LIMITATIONS  : High confidence on a weak setup just means the lenses agree it is weak. Read it with StableScore, never alone.
# ==========================================================================
...
Confidence.SetDefaultColor(Color.WHITE);
AssignBackgroundColor(
      if confidence >= 85 then CreateColor(0, 175, 95)
      else if confidence >= 70 then CreateColor(0, 120, 125)
      else if confidence >= 55 then CreateColor(145, 120, 0)
      else if confidence >= 40 then CreateColor(90, 60, 30)
      else CreateColor(65, 28, 36));
